...
@Component({
  selector: 'app-finding-creation-modal',
  templateUrl: './finding-creation-modal.page.html',
  styleUrls: ['./finding-creation-modal.page.scss'],
})
export class FindingCreationModalPage implements OnInit {
  auditTypeDesc: any;
  title: any;
  finding: any;
